...
static constexpr auto qt_meta_stringdata_CLASSUdpListenerENDCLASS = QtMocHelpers::stringData(
    "UdpListener",
    "logReceived",
    "",
    "message",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUdpListenerENDCLASS_t qt_meta_stringdata_CLASSUdpListenerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 11),  // "logReceived"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 7),  // "message"
        QT_MOC_LITERAL(33, 8),  // "senderIp"
        QT_MOC_LITERAL(42, 23)   // "processPendingDatagrams"
    },
    "UdpListener",
    "logReceived",
    "",
...
void UdpListener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->logReceived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (UdpListener::*)(const QString & , const QString & );
            if (_t _q_method = &UdpListener::logReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UdpListener::logReceived(const QString & _t1, const QString & _t2)
{
